...
class AmazonAPI:
    ...
    def get_title(self):
        try:
            ...
            print(e)
            print(
                f"Can't get title of the product - {self.driver.current_url}")
            return None
    ...
    def get_seller(self):
        try:
            ...
            print(e)
            print(
                f"Can't get the seller for the product - {self.driver.current_url}")
            return None
    ...
    def get_price(self):
        ...
        try:
            ...
            try:
                ...
                print(e)
                print(
                    f"Can't get price for the product - {self.driver.current_url}")
                return None
        except Exception as e:
            print(e)
            print(
